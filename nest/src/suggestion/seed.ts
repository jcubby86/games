export const actions_past = [
  'threw coins off the top of the space needle trying to hit people. But soon upgraded to water balloons',
  ...
  'solved world hunger, cured cancer, and explored the deepest parts of the ocean',
  ...
  'fell into the pit of quicksand as he screamed in terror, but she only sank down to her ankles so it ended up being fine. ',
